...
public class QuizReaderImplementation implements QuizReader {
	...
	private String lireIntitule(Reader flux) throws IOException, QuizReaderException{
		...
		throw new QuizReaderException("Probleme de syntaxe dans la construction de la question.");
	}
	
	private String lireTypeQuestion(Reader flux) throws IOException, QuizReaderException{
		int characterCourant;

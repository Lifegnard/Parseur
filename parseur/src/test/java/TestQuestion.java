...
public class TestQuestion {
	...
	public void testGetIntitule() {
		...
		Question questionTest = new Question("Intitule de la question de test",
				listeReponse);
		assertEquals("Intitule de la question de test",
				questionTest.getIntituleQuestion());
	}
	...
	public void testsetPropositionReponses() {
		...
		assertEquals(nouvelleListeReponse,
				questionTest.getPropositionReponses());
	}

...
public class TestQuestion {
	...
	public void testGetIntitule() {
		this.questionTest = new Question("Intitule de la question de test",
				this.listReponse);

		assertEquals("Intitule de la question de test",
				this.questionTest.getIntituleQuestion());
	}
	...
	public void testgetPropositionReponses() {
		...
		assertEquals(this.listReponse,
				this.questionTest.getPropositionReponses());
	}
	...
	public void testsetPropositionReponses() {
		...
		assertEquals(this.nouvelleListeReponse,
				this.questionTest.getPropositionReponses());
	}
